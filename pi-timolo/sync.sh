...
SYNC_DIR='project'            # relative to this script folder - location of files to sync
FILES_TO_SYNC='*'            # Set the type of files to sync * for all
CHECK_FOR_SYNC_FILE=false     # true if sync file below is required otherwise set to false always sync
